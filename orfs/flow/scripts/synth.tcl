...
# Tie-cell insertion (optional; SCL180 FS120 has no tiehi/tielo)
if { [info exists ::env(TIEHI_CELL_AND_PORT)] && [info exists ::env(TIELO_CELL_AND_PORT)] &&
     $::env(TIEHI_CELL_AND_PORT) ne "" && $::env(TIELO_CELL_AND_PORT) ne "" } {
  ...
  puts "INFO: No TIEHI/TIELO cells defined; skipping hilomap."
}
